/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 8ba6f083308f468b0853eaf539cf9e60)
...
interface __BaseEnv_Env {
	...
	SPELL_BOOKS: DurableObjectNamespace<import("./worker/index").SpellBookCache>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "GameRoom" | "Matchmaker" | "SpellBookCache";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEEPSEEK_MODEL" | "MATCH_ADMISSION" | "INPUT_POLICY_MODE" | "DEEPSEEK_API_KEY">> {}
}
